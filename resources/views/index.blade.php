        ...
        <section class="bg-purple-800 text-white p-8 pt-16 mt-12">
            <div class="container mx-auto flex flex-col md:flex-row items-center">
                ...
                <div class="w-full md:w-1/2 text-center md:text-left mb-8 md:mb-0 fade-in-bottom">
                    <h1 class="text-6xl font-bold mb-4 ">Online Wedding Invitations</h1>
                    <p class="text-2xl mb-6">Fun, exciting, and trendy Online Invitations right at your fingertips.</p>
                    <a href="#"
                ...
                <div class="w-full md:w-1/2 md:ml-8 lg:ml-32">
                    <div class="rounded-lg border border-white overflow-hidden">
                        <video class="w-full h-96 object-cover rounded-lg"
                            src="https://99invites.com/wp-content/uploads/2021/09/ezgif.com-gif-maker-1-1.mp4" autoplay
                ...
                <div class="grid grid-cols-2 md:grid-cols-5 gap-4">
                    <a href="{{route('card_1')}}">
                        <div
                            ...
                            <img src="{{asset('assets/img/Vintage-Copy.jpg')}}" alt="Vintage" class="w-full">
                            <p class="text-center font-bold py-2">Vintage</p>
                        </div>
                    </a>
                    <a href={{route('card_2')}}>
                        <div
                            class="bg-white shadow-md rounded-lg overflow-hidden hover:shadow-lg transition-shadow duration-300 hover-fade-in">
                            <img src="{{asset('assets/img/Trending-Indian.jpg')}}" alt="Trending Indian" class="w-full">
                            <p class="text-center font-bold py-2">Trending Indian</p>
                        </div>
                    </a>
                    <a href="{{route('card_3')}}">
                        <div
                            ...
                            <p class="text-center font-bold py-2">Traditional Wedding</p>
                        </div>
                    </a>
                    <a href="card-4.html">
                        <div
                            ...
                            <p class="text-center font-bold py-2">Royal</p>
                        </div>
                    </a>
                    <a href="card-5.html">
                        <div
                            ...
                            <p class="text-center font-bold py-2">Muslim Wedding</p>
                        </div>
                    </a>
                </div>
